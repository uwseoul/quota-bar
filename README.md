...
### 1. 릴리즈 다운로드 (권장)
가장 빠르고 쉬운 방법입니다. 
1. [Releases](https://github.com/uwseoul/glm-bar/releases) 페이지에서 최신 버전의 `glm-bar-macos.tar.gz` 파일을 다운로드합니다.
2. 압축을 해제한 후, 실행 파일(`glm-bar`)을 원하는 폴더로 옮깁니다.
3. 터미널에서 실행 권한을 부여합니다: `chmod +x glm-bar`
4. 실행합니다: `./glm-bar &`
